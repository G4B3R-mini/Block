...
//    applyFrom("${topsrcdir}/substitute-local-geckoview.gradle")
//}
//
//if (gradle.hasProperty('localProperties.autoPublish.android-components.dir')) {
//    ext.acSrcDir = gradle."localProperties.autoPublish.android-components.dir"
//    applyFrom("../${acSrcDir}/substitute-local-ac.gradle")
//}
//
//if (gradle.hasProperty('localProperties.autoPublish.application-services.dir')) {
//    ext.appServicesSrcDir = gradle."localProperties.autoPublish.application-services.dir"
//    applyFrom("../${appServicesSrcDir}/build-scripts/substitute-local-appservices.gradle")
//}