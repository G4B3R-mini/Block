...
// */
//val Context.application2: BrowserApplication
//    get() = applicationContext as BrowserApplication
//
///**
// * Get the requireComponents of this application.
// */
//val Context.components2: Components
//    get() = application2.components
//
//fun Context.getPreferenceKey2(@StringRes resourceId: Int): String =
...
// */
//fun Context.share2(text: String, subject: String = ""): Boolean {
//    return try {
...
//}
//
//fun Context.settings2() = components2.settings