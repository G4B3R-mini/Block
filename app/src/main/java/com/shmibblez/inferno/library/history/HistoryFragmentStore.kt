...
sealed class HistoryFragmentAction : Action {
    ...
    /**
     * Updates the empty state of [com.shmibblez.inferno.library.history.HistoryView].
     */
    data class ChangeEmptyState(val isEmpty: Boolean) : HistoryFragmentAction()

    /**
     * Updates the set of items marked for removal from the [com.shmibblez.inferno.components.AppStore]
