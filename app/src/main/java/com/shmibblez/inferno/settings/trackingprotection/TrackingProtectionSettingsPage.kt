package com.shmibblez.inferno.settings.trackingprotection
...
@Composable
fun TrackingProtectionSettingsPage(goBack: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = { InfernoText("Tracking Protection Settings") }, // todo: string res
            )
        },
    ) {
        LazyColumn(
