...
import com.shmibblez.inferno.settings.biometric.BiometricPromptPreferenceFragment
...
class AutofillSettingFragment : BiometricPromptPreferenceFragment() {
    ...
    internal fun updateAddressPreference(
        ...
        if (hasAddresses) {
            ...
            manageAddressesPreference.setIcon(R.drawable.ic_new_24)
            manageAddressesPreference.title =
    ...
    internal fun updateCardManagementPreference(
        ...
        if (hasCreditCards) {
            ...
            manageSavedCardsPreference.setIcon(R.drawable.ic_new_24)
            manageSavedCardsPreference.title =
