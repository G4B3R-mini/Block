package com.shmibblez.inferno.feature.downloads
...
import com.shmibblez.inferno.feature.downloads.manager.AndroidDownloadManager
...
class InfernoDownloadsFeature(
    ...
    private val downloadManager: InfernoDownloadManager = AndroidDownloadManager(
    ...
    private val customFirstPartyDownloadDialog: ((Filename, ContentSize, PositiveActionCallback, NegativeActionCallback) -> Unit)? = null,
    private val customThirdPartyDownloadDialog: ((ThirdPartyDownloaderApps, ThirdPartyDownloaderAppChosenCallback, NegativeActionCallback) -> Unit)? = null,
    private val appDownloadDialog: ((downloaderApps: List<DownloaderApp>, onAppSelected: (DownloaderApp) -> Unit, onDismiss: () -> Unit) -> Unit)? = null,
    ...
    /**
     * Calls the tryAgain function of the corresponding [InfernoDownloadManager]
     */
    @Suppress("Unused")
    ...
    /**
     * Notifies the [InfernoDownloadManager] that a new download must be processed.
     */
    @VisibleForTesting
...
//                    emitPromptDismissedFact()
    ...
    @VisibleForTesting
    internal fun onDownloaderAppSelected(
    ...
    private fun getAppDownloaderDialog() =
        findPreviousAppDownloaderDialogFragment() ?: DownloadAppChooserDialog.newInstance(
